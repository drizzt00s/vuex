...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mutations = {
		'ADD_LIST': function ADD_LIST(state) {
			var newList = {};
		...
		'CHANGE_ACTIVE_NOTE': function CHANGE_ACTIVE_NOTE(state, note) {
			state.activeList = note;
		},

		'EDIT_NOTE': function EDIT_NOTE(state, newContents) {
		...
		'TOGGLE_FAVORITE': function TOGGLE_FAVORITE(state, activeNote) {
		...
		'SHOW_FAVORITES': function SHOW_FAVORITES(state) {
			var favoriteNotes = [];
			for (var i = 0; i < state.lists.length; i++) {
		...
		'SHOW_ALL_NOTES': function SHOW_ALL_NOTES(state) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\root.vue: named exports in *.vue files are ignored.")}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-57a8becf/sidebar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
		vuex: {
			...
			actions: {
				addList: _action.addList,
				deleteNote: _action.deleteNote,
				toggleFavorite: _action.toggleFavorite
			}
		}
		// </script>
	...
	// 	<div id='toolbar'>
	// 		<i @click='addList' class='glyphicon glyphicon-plus'></i>
	// 		<i @click='toggleFavorite(activeNote)' class="glyphicon glyphicon-star" :class="activeNote.isFavorite ? 'starred' : '' "></i>
...
/***/ (function(module, exports) {
	...
	var addList = exports.addList = function addList(store) {
		var dispatch = store.dispatch;
		dispatch('ADD_LIST');
	};

	var editNote = exports.editNote = function editNote(store, event) {
		var dispatch = store.dispatch;
		var contents = event.target.value;
		dispatch('EDIT_NOTE', contents);
	};

	var changeAvtiveNote = exports.changeAvtiveNote = function changeAvtiveNote(store, note) {
		var dispatch = store.dispatch;
		dispatch('CHANGE_ACTIVE_NOTE', note);
	};

	var deleteNote = exports.deleteNote = function deleteNote(store) {
		var dispatch = store.dispatch;
		dispatch('DELETE_NOTE');
	};

	var toggleFavorite = exports.toggleFavorite = function toggleFavorite(store, activeNote) {
		var dispatch = store.dispatch;
		dispatch('TOGGLE_FAVORITE', activeNote);
	};

	var showFavorites = exports.showFavorites = function showFavorites(store) {
		var dispatch = store.dispatch;
		dispatch('SHOW_FAVORITES');
	};

	var showAllNotes = exports.showAllNotes = function showAllNotes(store) {
		var dispatch = store.dispatch;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-58f2116c/content.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    vuex: {
	        ...
	        actions: {
	            changeAvtiveNote: _action.changeAvtiveNote,
	            showFavorites: _action.showFavorites,
	            showAllNotes: _action.showAllNotes
	        }
	    }
	    // </script>
	...
	//           <button type="button" class="btn btn-default" @click='showAllNotes'>
	//             All Notes
	//           </button>
	//         </div>
	//         <div class="btn-group" role="group">
	//           <button type="button" class="btn btn-default" @click='showFavorites'>
	//             Favorites
	//           </button>
	//         </div>
	//       </div>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\edit.vue: named exports in *.vue files are ignored.")}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
		vuex: {
			getters: {
				activeListData: function activeListData(state) {
					return state.activeList.listData;
				}
			},
			actions: {
				editNote: _action.editNote
			}
		}
		// </script>
	...
	//   <div id="note-editor">
	//     <textarea class="form-control" :value='activeListData' @input='editNote($event)'>
	//     </textarea>
	//   </div>
	// </template>
	//
